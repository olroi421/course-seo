...
- **PageRank** досі працює — авторитетність передається через посилання
- **Якість > кількість** — одне посилання з Forbes цінніше за 1000 зі спаму
- **Природність** — різноманітні джерела, anchor texts, поступове зростання
- **White-hat стратегії** — guest posting, digital PR, HARO, broken link building
- **Маніпулятивні тактики** — ризик санкцій від Google Penguin

> 🔑 Link building — це побудова репутації в цифровому середовищі.
